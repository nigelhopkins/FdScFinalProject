...
Public Class MDIParent1
    ...
    Private Sub AccountManagerToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AccountManagerToolStripMenuItem.Click
        If Login = 1 Then
            frmAccountManager.MdiParent = Me
    ...
    Private Sub StockManagerToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles StockManagerToolStripMenuItem.Click
        If Login = 1 Then
            frmStockManager.MdiParent = Me
    ...
    Private Sub WebsiteManagerToolStripMenuItem_Click(sender As Object, e As EventArgs)
        If Login = 1 Then
            frmWebsiteManager.MdiParent = Me
