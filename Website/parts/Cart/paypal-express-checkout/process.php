...
include_once("Parts/Cart/paypal-express-checkout/paypal.class.php");

$PayPalMode         = 'sandbox'; // sandbox or live
$PayPalApiUsername  = 'nigel.hopkins460_api1.live.cornwall.ac.uk'; //PayPal API Username
$PayPalApiPassword  = 'Q4EUYART23K2QM83'; //Paypal API password
$PayPalApiSignature     = 'An5ns1Kso7MWUdW4ErQKJJJ4qi4-AvGnu7Pz2AbhSqgfbpOldv7EQi4a'; //Paypal API Signature
